...
const CURATED_TOKENS: TokenSeed[] = [
  ...
  { address: '0x0b3e328455c4059EEb9e3f84b5543F74E24e7E1b', symbol: 'VIRTUAL', name: 'Virtual Protocol',  decimals: 18, network: 'base-mainnet', is_memecoin: 0, drop_pct: 0.7, rise_pct: 1.0, strategy: 'candle' },
  ...
  { address: '0x4ed4E862860beD51a9570b96d89aF5E1B0Efefed', symbol: 'DEGEN',   name: 'Degen',             decimals: 18, network: 'base-mainnet', is_memecoin: 1, drop_pct: 0.7, rise_pct: 1.0, strategy: 'candle' },
  { address: '0x532f27101965dd16442E59d40670FaF5eBB142E4', symbol: 'BRETT',   name: 'Brett',             decimals: 18, network: 'base-mainnet', is_memecoin: 1, drop_pct: 0.7, rise_pct: 1.0, strategy: 'candle' },
];
